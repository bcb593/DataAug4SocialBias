...
prompt_path='/scratch0/bashyalb/DataAug4SocialBias/SentenceGeneration/Data/prompts/samediversegen.txt'
sentences_path = '/scratch0/bashyalb/DataAug4SocialBias/SentenceGeneration/Data/DebiasingCorpus/corpus(10-40)10k.txt'
...
def get_llama_response(prompt: str) -> str:
    full_text = llama_pipeline(prompt, max_length=1600)[0]['generated_text']
    return full_text
...
def return_relevant_sentences(sentences_path, prompt_path):
    ...
    for i, sentence in enumerate(tqdm(sentences[:6], desc="Processing sentences")):
